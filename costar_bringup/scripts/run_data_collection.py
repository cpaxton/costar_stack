...
primesense_cmd = ["roslaunch", "openni2_launch",
    ...
    # WORKS! # used this previously: ,"device_id:=1311220031"
kinect2_cmd = ["roslaunch", "kinect2_bridge",
               "kinect2_bridge.launch"]  # WORKS!

# with xbox 360 kinectv1
# camera_cmds =
# [('kinect',kinect_cmd),('primesense',primesense_cmd),('kinect2',kinect2_cmd)]
...
try:
    ...
    while True:
        ...
        for device_name, cmd in camera_cmds:
            ...
            test_proc = Popen(["rosbag", "record", "-a", "--duration=5", "--size=150", "--output-name=%s_iter_%s_%s_%s_%s.bag" %
                              (time_str, (i), device_name, object_name, object_orientation)])
